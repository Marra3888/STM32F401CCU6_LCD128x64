...
// ---- 6x8 глифы для кириллицы без ASCII-аналогов ----
// bit0 в каждом байте = верхний пиксель, 6 столбцов на символ
// 'П' (U+041F): бортик сверху + две вертикали
static const uint8_t RU_P_CAP[6] = {
